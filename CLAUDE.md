...
- **UI PROTOTYPE built** (`kiwimath_prototype.html`, openable): modern 4-tab redesign (Olympiad levels / School grades / Progress / Profile), wired to real counts, fully jsdom-QA'd. Practice screen now shows a distinct real question PER topic (fixed the "two topics same question" placeholder bug). To become Flutter next.
